...
function quick_sort( input_array ) {
    ...
    const left_array = [];
    const right_array = [];
    /* loop through input_array to push values smaller than pivot into 
    left_array and bigger than pivot into right_array */
    ...
    /* Recursive case: return the concatenated array containing all values in 
    fully sorted left_array, pivot, and fully sorted right_array 
    (fully sort by calling quick_sort itself on left_array and right_array) */
